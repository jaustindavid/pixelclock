...
class Weather_Graphics:
    ...
    def update_display(self):
        ...
        # Draw the main text
        (font_width, font_height), (offset_x, offset_y) = large_font.font.getsize(self._main_text)
        draw.text(
        ...
        (font_width, font_height), (offset_x, offset_y) = small_font.font.getsize(self._description)
        draw.text(
        ...
        (font_width, font_height), (offset_x, offset_y) = large_font.font.getsize(self._temperature)
        draw.text(
            (
